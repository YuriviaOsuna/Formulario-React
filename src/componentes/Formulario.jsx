  ...
  return (
    <div className='contenedor-formulario'>
      ...
      <div className='contenedor-encabezado'>
        <br></br>
        <h2>Seguimiento vacuna COVID-19</h2>
      </div>
      ...
      <div className='contenedor-datos'>
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          >
            ...
            <MuiTelInput label="Telefono(Opcional)" placeholder="+52" value={phone} onChange={handleChange} />
...
const validationSchema = yup.object({
  ...
  telefono: yup
    .string('Introduce tu telefono')
    .max(10, 'El número de telefono debe tener 10  dígitos')
